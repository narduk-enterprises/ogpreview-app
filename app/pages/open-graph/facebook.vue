<template>
  <LayoutsArticleLayout
    ...
    description="The exact Open Graph specifications for Facebook. Copy-paste the required meta tags, image sizes, and best practices for perfect link previews."
