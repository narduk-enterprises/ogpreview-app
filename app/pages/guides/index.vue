    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-6 mb-12">
        <NuxtLink
          ...
          class="group bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl hover:scale-105 transition-all duration-200"
        >
          <div class="mb-4 flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 group-hover:scale-110 transition-transform">
            <UIcon :name="guide.icon" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
          </div>
          ...
          <div class="text-blue-600 dark:text-blue-400 text-sm font-medium flex items-center gap-1">
            Read guide
